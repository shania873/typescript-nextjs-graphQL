...
import AddContactForm from "./AddContactForm"; // Assuming you meant to import AddContactForm.
import EditContactForm from "./EditContactForm";

interface Entity {
  __typename: "Contact" | "Company"; // Reflects the GraphQL type names
  id: string;
  name: string;
  email?: string;
  contactEmail?: string;
...
function EntityList() {
  ...
  const handleSave = () => {
    refetch(); // Or any other logic that should occur after saving
  };
  return (
    <div>
      <div className="overflow-x-auto relative">
        <div className="pt-5 pb-5 flex justify-end pr-5">
          ...
          {/* Assuming AddContactForm is the correct component */}
        </div>
